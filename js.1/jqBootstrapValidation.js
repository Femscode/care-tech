      ...
      init : function( options ) {
        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            //                                                    NUMBER
            // ---------------------------------------------------------
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "mobile") {
              message = settings.builtInValidators.number.message;
              if ($this.data("validationMobileMessage")) {
                message = $this.data("validationMobileMessage");
              }
              $this.data("validationMobileMessage", message);
            }
            // ---------------------------------------------------------
            //                                                     EMAIL
            // ---------------------------------------------------------
